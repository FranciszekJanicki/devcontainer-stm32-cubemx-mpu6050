...
namespace MPU6050 {
    ...
    DMP::DMP(MPU6050&& mpu6050) noexcept : mpu6050_{std::forward<MPU6050>(mpu6050)}
    {
        this->initialize();
    }
    ...
    void DMP::initialize_dmp() const noexcept
    {
    ...
    void DMP::initialize_offsets() const noexcept
    {
    ...
    void DMP::deinitialize() noexcept
    {
        this->initialized_ = false;
    }

    bool DMP::get_otp_bank_valid() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::XG_OFFS_TC),
                                                   std::to_underlying(TC::OTP_BNK_VLD_BIT));
    }

    void DMP::set_otp_bank_valid(bool const valid) const noexcept
    {
    ...
    void DMP::set_x_gyro_offset_tc(std::uint8_t const offset) const noexcept
    {
    ...
    void DMP::set_y_gyro_offset_tc(std::uint8_t const offset) const noexcept
    {
    ...
    void DMP::set_z_gyro_offset_tc(std::uint8_t const offset) const noexcept
    {
    ...
    void DMP::set_int_pll_ready_enabled(bool const enabled) const noexcept
    {
    ...
    void DMP::set_int_dmp_enabled(bool const enabled) const noexcept
    {
        this->mpu6050_.i2c_device_.write_bit(std::to_underlying(RA::INT_ENABLE),
                                             enabled,
    ...
    bool DMP::get_dmp_int_5_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_5_BIT));
    }

    bool DMP::get_dmp_int_4_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_4_BIT));
    }

    bool DMP::get_dmp_int_3_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_3_BIT));
    }

    bool DMP::get_dmp_int_2_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_2_BIT));
    }

    bool DMP::get_dmp_int_1_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_1_BIT));
    }

    bool DMP::get_dmp_int_0_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::DMP_INT_STATUS),
                                                   std::to_underlying(DMP_INT::DMPINT_0_BIT));
    }

    bool DMP::get_int_pll_ready_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::INT_STATUS),
                                                   std::to_underlying(INT_STATUS::PLL_RDY_INT_BIT));
    }

    bool DMP::get_int_dmp_status() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_bit(std::to_underlying(RA::INT_STATUS),
                                                   std::to_underlying(INT_STATUS::DMP_INT_BIT));
    }

    void DMP::set_dmp_enabled(bool const enabled) const noexcept
    {
    ...
    void DMP::reset_dmp() const noexcept
    {
        this->mpu6050_.i2c_device_.write_bit(std::to_underlying(RA::USER_CTRL),
                                             true,
    ...
    void DMP::set_memory_bank(std::uint8_t const bank, bool const prefetch_enabled, bool const user_bank) const noexcept
    {
    ...
    void DMP::set_memory_start_address(std::uint8_t const address) const noexcept
    {
        this->mpu6050_.i2c_device_.write_byte(std::to_underlying(RA::MEM_START_ADDR), address);
    }

    std::uint8_t DMP::read_memory_byte() const noexcept
    {
        return this->mpu6050_.i2c_device_.read_byte(std::to_underlying(RA::MEM_R_W));
    }

    void DMP::write_memory_byte(std::uint8_t const data) const noexcept
    {
        this->mpu6050_.i2c_device_.write_byte(std::to_underlying(RA::MEM_R_W), data);
    }

    void DMP::read_memory_block(std::uint8_t* read_data,
    ...
    void DMP::write_memory_block(std::uint8_t* write_data,
    ...
    void DMP::write_dmp_configuration_set(std::uint8_t* write_data, std::size_t const write_size) const noexcept
    {
        for (std::int16_t i = 0; i < write_size;) {
    ...
    void DMP::set_dmp_config1(std::uint8_t const config) const noexcept
    {
        this->mpu6050_.i2c_device_.write_byte(std::to_underlying(RA::DMP_CFG_1), config);
    }

    void DMP::set_dmp_config2(std::uint8_t const config) const noexcept
    {
